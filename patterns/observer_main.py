# Наблюдатель
# Также известен как: Издатель-Подписчик, Слушатель, Observer, Event-Subscriber, Listener
...
class ConcreteSubject(Subject):
    ...
    def attach(self, observer: Observer) -> None:
        print("Издатель: Прикрепил наблюдателя.")
    ...
    def notify(self) -> None:
        ...
        print("Издатель: Уведомление наблюдателей ...")
    ...
    def some_business_logic(self) -> None:
        ...
        print(f"Издатель: Мое состояние только что изменилось на {self._state}")
        self.notify()
